import {
  D as resolveAwsSdkSigV4Config,
  F as normalizeProvider,
  G as getSmithyContext,
  J as EndpointCache,
  L as awsEndpointFunctions,
  M as customEndpointFunctions,
  K as resolveEndpoint,
  n as toUtf8,
  O as fromUtf8,
  A as parseUrl,
  Q as NoOpLogger,
  R as AwsSdkSigV4Signer,
  t as toBase64,
  k as fromBase64,
  S as emitWarningIfUnsupportedVersion,
  T as resolveDefaultsModeConfig,
  U as emitWarningIfUnsupportedVersion$1,
  B as loadConfig,
  p as streamCollector,
  V as Hash,
  N as NodeHttpHandler,
  W as createDefaultUserAgentProvider,
  X as calculateBodyLength,
  Y as NODE_APP_ID_CONFIG_OPTIONS,
  Z as NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS,
  _ as NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS,
  $ as NODE_RETRY_MODE_CONFIG_OPTIONS,
  a0 as DEFAULT_RETRY_MODE,
  a1 as NODE_REGION_CONFIG_FILE_OPTIONS,
  a2 as NODE_REGION_CONFIG_OPTIONS,
  a3 as NODE_MAX_ATTEMPT_CONFIG_OPTIONS,
  a4 as NODE_AUTH_SCHEME_PREFERENCE_OPTIONS,
  a5 as loadConfigsForDefaultMode,
  a6 as getAwsRegionExtensionConfiguration,
  a7 as getDefaultExtensionConfiguration,
  a8 as getHttpHandlerExtensionConfiguration,
  a9 as resolveAwsRegionExtensionConfiguration,
  aa as resolveDefaultRuntimeConfig,
  ab as resolveHttpHandlerRuntimeConfig,
  ac as Client,
  ad as resolveUserAgentConfig,
  ae as resolveRetryConfig,
  af as resolveRegionConfig,
  ag as resolveEndpointConfig,
  ah as resolveHostHeaderConfig,
  ai as getUserAgentPlugin,
  aj as getRetryPlugin,
  ak as getContentLengthPlugin,
  al as getHostHeaderPlugin,
  am as getLoggerPlugin,
  an as getRecursionDetectionPlugin,
  ao as getHttpAuthSchemeEndpointRuleSetPlugin,
  ap as DefaultIdentityProviderConfig,
  aq as getHttpSigningPlugin,
  ar as ServiceException,
  as as SENSITIVE_STRING,
  aI as parseXmlBody,
  h as extendedEncodeURIComponent,
  H as HttpRequest,
  aJ as parseXmlErrorBody,
  aD as withBaseException,
  az as expectString,
  aK as strictParseInt32,
  aE as decorateServiceException,
  aw as expectNonNull,
  aL as parseRfc3339DateTimeWithOffset,
  aF as Command,
  aG as getSerdePlugin,
  aH as getEndpointPlugin,
  s as setCredentialFeature,
} from './main-y3006xry.js';
import 'buffer';
import 'stream';
import 'node:stream';
import 'http';
...
import {
  p as packageInfo,
  c as createAggregatedClient,
} from './package-BgDBADa7.js';
...
const a = false,
  ...
  u = {
    ...
    properties: {
      authSchemes: [{ name: e, signingName: f, signingRegion: g }],
    },
    headers: {},
  },
  v = {},
  ...
  rules: [
    {
      ...
      rules: [
        {
          conditions: [{ [H]: d, [I]: [q, 'ap-northeast-1'] }],
          endpoint: u,
          [G]: h,
        },
        {
          conditions: [{ [H]: d, [I]: [q, 'ap-south-1'] }],
          endpoint: u,
          [G]: h,
        },
        {
          conditions: [{ [H]: d, [I]: [q, 'ap-southeast-1'] }],
          endpoint: u,
          [G]: h,
        },
        {
          conditions: [{ [H]: d, [I]: [q, 'ap-southeast-2'] }],
          endpoint: u,
          [G]: h,
        },
        w,
        {
          conditions: [{ [H]: d, [I]: [q, 'ca-central-1'] }],
          endpoint: u,
          [G]: h,
        },
        {
          conditions: [{ [H]: d, [I]: [q, 'eu-central-1'] }],
          endpoint: u,
          [G]: h,
        },
        {
          conditions: [{ [H]: d, [I]: [q, 'eu-north-1'] }],
          endpoint: u,
          [G]: h,
        },
        {
          conditions: [{ [H]: d, [I]: [q, 'eu-west-1'] }],
          endpoint: u,
          [G]: h,
        },
        {
          conditions: [{ [H]: d, [I]: [q, 'eu-west-2'] }],
          endpoint: u,
          [G]: h,
        },
        {
          conditions: [{ [H]: d, [I]: [q, 'eu-west-3'] }],
          endpoint: u,
          [G]: h,
        },
        {
          conditions: [{ [H]: d, [I]: [q, 'sa-east-1'] }],
          endpoint: u,
          [G]: h,
        },
        { conditions: [{ [H]: d, [I]: [q, g] }], endpoint: u, [G]: h },
        {
          conditions: [{ [H]: d, [I]: [q, 'us-east-2'] }],
          endpoint: u,
          [G]: h,
        },
        {
          conditions: [{ [H]: d, [I]: [q, 'us-west-1'] }],
          endpoint: u,
          [G]: h,
        },
        {
          conditions: [{ [H]: d, [I]: [q, 'us-west-2'] }],
          endpoint: u,
          [G]: h,
        },
        {
          endpoint: {
            ...
            properties: {
              authSchemes: [
                { name: e, signingName: f, signingRegion: '{Region}' },
              ],
            },
            headers: v,
          },
...
const getRuntimeConfig$1 = (config) => {
  return {
    ...
    httpAuthSchemeProvider:
      config?.httpAuthSchemeProvider ?? defaultSTSHttpAuthSchemeProvider,
...
const getRuntimeConfig = (config) => {
  ...
  return {
    ...
    authSchemePreference:
      ...
      loadConfig(NODE_AUTH_SCHEME_PREFERENCE_OPTIONS, profileConfig),
    ...
    httpAuthSchemes: config?.httpAuthSchemes ?? [
      {
        ...
        identityProvider: (ipc) =>
          ...
          (async (idProps) =>
            await config.credentialDefaultProvider(idProps?.__config || {})()),
        signer: new AwsSdkSigV4Signer(),
      },
      {
        schemeId: 'smithy.api#noAuth',
    ...
    maxAttempts:
      config?.maxAttempts ??
      loadConfig(NODE_MAX_ATTEMPT_CONFIG_OPTIONS, config),
    region:
      config?.region ??
    ...
    useDualstackEndpoint:
      ...
      loadConfig(NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS, profileConfig),
    useFipsEndpoint:
      config?.useFipsEndpoint ??
      loadConfig(NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS, profileConfig),
    userAgentAppId:
      config?.userAgentAppId ??
      loadConfig(NODE_APP_ID_CONFIG_OPTIONS, profileConfig),
  };
};
  ...
  Object.entries(formEntries)
    .map(
      ([key, value]) =>
        ...
        '=' +
        extendedEncodeURIComponent(value),
    )
    .join('&');
...
class AssumeRoleCommand extends Command.classBuilder()
  .ep(commonParams)
...
class AssumeRoleWithWebIdentityCommand extends Command.classBuilder()
  .ep(commonParams)
  .m(function (Command, cs, config, o) {
    return [
      getSerdePlugin(config, this.serialize, this.deserialize),
...
const getDefaultRoleAssumer = (stsOptions = {}, stsPlugins) =>
  getDefaultRoleAssumer$1(
    stsOptions,
    getCustomizableStsClientCtor(STSClient, stsPlugins),
  );
const getDefaultRoleAssumerWithWebIdentity = (stsOptions = {}, stsPlugins) =>
...
//# sourceMappingURL=index-DOmQUwBX.js.map
