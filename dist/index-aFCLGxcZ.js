import { D as resolveAwsSdkSigV4Config, F as normalizeProvider, G as getSmithyContext, J as EndpointCache, K as resolveEndpoint, L as awsEndpointFunctions, M as customEndpointFunctions, n as toUtf8, O as fromUtf8, A as parseUrl, Q as NoOpLogger, R as AwsSdkSigV4Signer, t as toBase64, k as fromBase64, S as emitWarningIfUnsupportedVersion, T as resolveDefaultsModeConfig, U as emitWarningIfUnsupportedVersion$1, B as loadConfig, p as streamCollector, V as Hash, N as NodeHttpHandler, W as createDefaultUserAgentProvider, X as calculateBodyLength, Y as NODE_APP_ID_CONFIG_OPTIONS, Z as NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS, _ as NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS, $ as NODE_RETRY_MODE_CONFIG_OPTIONS, a0 as DEFAULT_RETRY_MODE, a1 as NODE_REGION_CONFIG_FILE_OPTIONS, a2 as NODE_REGION_CONFIG_OPTIONS, a3 as NODE_MAX_ATTEMPT_CONFIG_OPTIONS, a4 as NODE_AUTH_SCHEME_PREFERENCE_OPTIONS, a5 as loadConfigsForDefaultMode, a6 as getAwsRegionExtensionConfiguration, a7 as getDefaultExtensionConfiguration, a8 as getHttpHandlerExtensionConfiguration, a9 as resolveAwsRegionExtensionConfiguration, aa as resolveDefaultRuntimeConfig, ab as resolveHttpHandlerRuntimeConfig, ac as Client, ad as resolveUserAgentConfig, ae as resolveRetryConfig, af as resolveRegionConfig, ag as resolveEndpointConfig, ah as resolveHostHeaderConfig, ai as getUserAgentPlugin, aj as getRetryPlugin, ak as getContentLengthPlugin, al as getHostHeaderPlugin, am as getLoggerPlugin, an as getRecursionDetectionPlugin, ao as getHttpAuthSchemeEndpointRuleSetPlugin, ap as DefaultIdentityProviderConfig, aq as getHttpSigningPlugin, ar as ServiceException, as as SENSITIVE_STRING, at as take, au as _json, av as map, aw as expectNonNull, ax as expectObject, ay as parseJsonBody, az as expectString, aA as expectInt32, aB as parseJsonErrorBody, aC as loadRestJsonErrorCode, aD as withBaseException, aE as decorateServiceException, aF as Command, aG as getSerdePlugin, aH as getEndpointPlugin } from './main-y3006xry.js';
import 'buffer';
import 'stream';
import 'node:stream';
import 'http';
...
import 'path';
import 'crypto';
import { p as packageInfo, c as createAggregatedClient } from './package-BgDBADa7.js';
